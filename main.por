programa
{
	...
	//só posso mostrar o alerta de meta se a pessoa colocar a meta. Criar uma função específica pra mostrar os dados com o alerta?
	//área onde pode economizar?
	...
	funcao registrarDespesa(){
		...
		se (v > 0 e c != "" e c!= " " e d != "" e d != " "){
			...
			senao{
				escreva("\nfunção registrarDespesa(): O usuário digitou uma categoria de despesa inválida!")
			}
	
		}senao{
			escreva("Digite todos os campos corretamente.")
		}
	...
	funcao cadastrarMeta(){
		...
		escreva("\nEm qual categoria deseja pôr a meta? \n1- Alimentação \n2 - Transpornte \n3 - Moradia \n4 - Lazer \n=>")
		leia(cat)
	...
	enquanto(op != -1){
		...
		senao se(op == 2){
			//calcular as despesas chamando cada método -> poupar memória da máquina.
			calcularDespesaTotal(dados_despesas)
			
				escreva("\n---------- Extrato Bancário Simplificado ----------")
				escreva("\nSaldo atual: R$", saldo)
		...
		senao se(op == 3){
			//TODO -> Definir Metas de Orçamento 
 ...
 * 
 * @POSICAO-CURSOR = 8120; 
 * @DOBRAMENTO-CODIGO = [30, 40, 90, 104, 110, 126, 142, 158, 174, 229, 257, 265, 273, 281, 289, 346, 442, 503, 508];
 * @PONTOS-DE-PARADA = ;
